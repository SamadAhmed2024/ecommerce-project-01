            ...
            <div className="row">
                <div className="col-md-3 p-2">
                    <div className="card vh-100 p-3 shadow-sm">
                        ...
                        <select value="" className="form-control form-select">
                        ...
                        <input value={Filter.PriceMax} onChange={(e)=>{InputOnChange("PriceMax",e.target.value)}} min={0} max={1000000} step={1000} type="range" className="form-range"/>


                        <label className="form-label mt-3">Minimum Price ${Filter.PriceMin}</label>
                        <input value={Filter.PriceMin} onChange={(e)=>{InputOnChange("PriceMin",e.target.value)}} min={0} max={1000000} step={1000} type="range" className="form-range"/>
